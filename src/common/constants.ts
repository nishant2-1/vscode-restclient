...
export const EncodeBase64VariableName = "$encodeBase64";
export const EncodeBase64Description = "Encode a string to base64 format";
export const DecodeBase64VariableName = "$decodeBase64";
export const DecodeBase64Description = "Decode a base64 string to plain text";
